...
void io_choose_starter()
{
  ...
  curs_set(1);
  do {
    mvprintw( 4, 20, "Here are three Pokemon,");
    mvprintw( 5, 20, "who only want to");
    mvprintw( 6, 20, "be your friend.");
    mvprintw( 8, 20, "You can only");
    mvprintw( 9, 20, "choose one. So, choose wisely");
